...
- `proxmox_http_headers` (string) - Set custom http headers e.g. `Key,Value,Key1,Value1`

- `proxmox_proxy_server` (string) - Proxy Server passed to Api client(useful for debugging). Syntax: `http://proxy:port`
